...
console.log("myFavoriteSuperheroes is " + myFavSuperheroes);

// Challenge 2: Print (in console) the first superheroes name in your array "myFavSuperheroes".
console.log("The first superhero in myFavSuperheroes is: " + myFavSuperheroes[0]);

// Challenge 3: Print (in console) the length of the array "myFavSuperheroes".
console.log("The length of myFavSuperheroes is:" + myFavSuperheroes.length )
...
myFavSuperheroes[4] = "bindhu shree";
...
var superheroUniverse = [
  ["doremon", "Iron Man", "Thor", "Hulk", "Black Panther"],
  ["Batman", "Superman", "spiderman", "ninga", "pokemon"]
];
